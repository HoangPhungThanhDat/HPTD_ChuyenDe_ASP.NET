...
//        public DbSet<Brand> Brands { get; set; }
//        public DbSet<Product> Products { get; set; }
//        public DbSet<User> Users { get; set; } // vẫn giữ lại để truy cập dữ liệu
//        public DbSet<Role> Roles { get; set; }
//        public DbSet<UserRole> UserRoles { get; set; }
//        public DbSet<Order> Orders { get; set; }
//        public DbSet<OrderDetail> OrderDetails { get; set; }
...
//        protected override void OnModelCreating(ModelBuilder modelBuilder)
//        {
//            base.OnModelCreating(modelBuilder); // ⚠️ Đặt dòng này TRƯỚC để Identity hoạt động đúng
...
//            modelBuilder.Entity<Brand>().HasQueryFilter(b => b.DeletedAt == null);
...
//            modelBuilder.Entity<OrderDetail>().HasQueryFilter(od => od.DeletedAt == null);
...
//            modelBuilder.Entity<UserAddress>().HasQueryFilter(ua => ua.DeletedAt == null);
//            modelBuilder.Entity<UserRole>().HasQueryFilter(ur => ur.DeletedAt == null);
//        }
//    }
//}
