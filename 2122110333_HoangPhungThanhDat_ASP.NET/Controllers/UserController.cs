...
using Microsoft.AspNetCore.Mvc;
using Microsoft.EntityFrameworkCore;
using Microsoft.AspNetCore.Identity; // Thêm namespace cho Identity
using System.Collections.Generic;
using System.Linq;
using System.Threading.Tasks;
...
namespace _2122110333_HoangPhungThanhDat_ASP.NET.Controllers
{
    ...
    {
        private readonly AppDbContext _context;
        private readonly PasswordHasher<User> _passwordHasher; // Khai báo PasswordHasher
        ...
        public async Task<IActionResult> UpdateUser(int id, User user)
        {
            ...
            // Nếu người dùng cập nhật mật khẩu, cần phải mã hóa lại mật khẩu
